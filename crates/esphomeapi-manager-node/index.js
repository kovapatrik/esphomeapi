  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      if (process.config?.variables?.shlib_suffix === 'dll.a' || process.config?.variables?.node_target_type === 'shared_library') {
        try {
        return require('./esphomeapi-manager.win32-x64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./esphomeapi-manager.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./esphomeapi-manager.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./esphomeapi-manager.openharmony-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./esphomeapi-manager.openharmony-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./esphomeapi-manager.openharmony-arm.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  try {
    wasiBinding = require('./esphomeapi-manager.wasi.cjs')
  ...
  if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
    try {
      wasiBinding = require('@kovapatrik/esphomeapi-manager-wasm32-wasi')
      nativeBinding = wasiBinding
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
        if (!wasiBindingError) {
